...
export default function GameOverScreen() {
  ...
  const hotStreakSetting = useGameStore((s) => s.hotStreakSetting);
  ...
  function rematch() {
    // Carry the previous game's turnStyle + hotStreakSetting into the
    // rematch — same group, same expectations. Alternating rematches
    // also re-roll the random starting team (handled in startGame).
    startGame({
